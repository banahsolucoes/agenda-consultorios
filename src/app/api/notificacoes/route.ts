...
// se a integração Google da clínica caiu de verdade (ver
// google.ts:googlePrecisaReconectar — mesma checagem usada pelo popup global
// de reconexão), e a contagem de EnvioFormulario PENDENTE (F2.5 — badge do
// link "Anamneses").
export async function GET() {
  ...
  const integracaoGoogleFalhou = clinica ? googlePrecisaReconectar(clinica) : false;
