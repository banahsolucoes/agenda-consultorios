...
Relações principais: `Clinica 1—N {Usuario, Paciente, TipoSessao, HorarioTrabalho, Anexo, Tarefa, LogAuditoria, Agendamento}`; `Paciente 1—N {Pacote, Agendamento, Consentimento, Anexo, Tarefa}`; `Pacote 1—N Agendamento`; `MentoriaAluno 1—N Agendamento` (reunião avulsa de mentorado, 2026-08-05).
...
| POST | `/api/agendamentos/mentoria` | `agendamentos/mentoria/route.ts` | Cria reunião avulsa de mentorado (sem pacote/numeração), Meet sempre gerado (2026-08-05) | `operarAgenda` |
